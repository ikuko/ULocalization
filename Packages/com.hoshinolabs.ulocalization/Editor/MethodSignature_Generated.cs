...
namespace HoshinoLabs.ULocalization {
	internal static partial class MethodSignature {
		static Dictionary<Type, Dictionary<string, string>> methodSignatures = new Dictionary<Type, Dictionary<string, string>> {
			...
			[typeof(global::HoshinoLabs.ULocalization.TMP_DropdownProxy)] = new Dictionary<string, string> {
			...
			[typeof(global::HoshinoLabs.ULocalization.VRCPickupProxy)] = new Dictionary<string, string> {
