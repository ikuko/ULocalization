...
namespace HoshinoLabs.ULocalization.Udon {
	internal static partial class UnityEventFilter {
		static Dictionary<Type, Dictionary<string, string>> allowedUnityEventTargetTypes = new Dictionary<Type, Dictionary<string, string>> {
			...
			[typeof(global::HoshinoLabs.ULocalization.TMP_DropdownExtension)] = new Dictionary<string, string> {
				["set_options"] = "HoshinoLabsULocalizationTMP_DropdownExtensions.__set_options__TMProTMP_DropdownOptionDataArray__SystemVoid",
				["get_name"] = "UnityEngineComponent.__get_name__SystemString",
				["set_name"] = "UnityEngineComponent.__set_name__SystemString__SystemVoid",
			},
			[typeof(global::HoshinoLabs.ULocalization.VRCPickupExtension)] = new Dictionary<string, string> {
				["get_InteractionText"] = "VRCSDK3ComponentsVRCPickup.__get_InteractionText__SystemString",
				["set_InteractionText"] = "VRCSDK3ComponentsVRCPickup.__set_InteractionText__SystemString__SystemVoid",
				["get_UseText"] = "VRCSDK3ComponentsVRCPickup.__get_UseText__SystemString",
				["set_UseText"] = "VRCSDK3ComponentsVRCPickup.__set_UseText__SystemString__SystemVoid",
				["get_name"] = "UnityEngineComponent.__get_name__SystemString",
				["set_name"] = "UnityEngineComponent.__set_name__SystemString__SystemVoid",
			},
